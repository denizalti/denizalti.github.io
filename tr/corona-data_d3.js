...
//-----------------------------DATA-----------------------------//
// date,cases,deaths,recovered,tests,critical
const timeConv = d3.timeParse("%d-%m-%Y");
const dataset = d3.csv("https://raw.githubusercontent.com/denizalti/covid-19-data-turkey/master/country-data.csv");
dataset.then(function(data) {
    const slices = data.columns.slice(5).map(function(id) {
        return {
            id: id,
